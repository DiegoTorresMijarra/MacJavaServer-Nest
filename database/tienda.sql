...
INSERT INTO "restaurantes" ("id", "nombre", "calle", "localidad", "borrado",  "creado_en", "actualizado_en")
VALUES
    (1, 'madre nodriza', 'espacial', 'Madrid', false, '1975-12-12', '2022-12-12'),
    (2, 'primer hijo', 'veloz', 'Getafe', false,  '2004-12-12', '2022-12-12'),
    (3, 'el abuelo', 'francisco', 'Toleod', true,  '1936-12-12', '2022-12-12');