...
describe('RestaurantesController (e2e)', () => {
  ...
  describe('GET /paginated', () => {
    it('debe devolver un array de restaurantes paginados', () => {
      ...
      const body = request(app.getHttpServer()).get(endpoint).expect(200)
      expect(() => {
  ...
  describe('GET /:id', () => {
    it('debe devolver un restaurante', () => {
      ...
      expect(() => {
        expect(body).toEqual(restaurante)
        expect(mockRestaurantesService.findOne).toHaveBeenCalledWith(
          restaurante.id,
        )
      })
    })
  ...
  describe('PATCH /:id', () => {
    it('debe devolver un restaurante', () => {
      ...
      expect(() => {
        expect(body).toEqual(restaurante)
        expect(mockRestaurantesService.update).toHaveBeenCalledWith(
          restaurante.id,
          updateRestaurante,
        )
      })
  ...
  describe('DELETE /:id', () => {
    it('debe devolver un restaurante', () => {
      ...
      expect(() => {
        expect(body).toEqual(restaurante)
        expect(mockRestaurantesService.removeSoft).toHaveBeenCalledWith(
          restaurante.id,
        )
      })
    })
  ...
  describe('GET /nombre/:nombre', () => {
    it('debe devolver un restaurante', () => {
      ...
      expect(() => {
        expect(body).toEqual(restaurante)
        expect(mockRestaurantesService.findByName).toHaveBeenCalledWith(
          restaurante.nombre,
        )
      })
    })
