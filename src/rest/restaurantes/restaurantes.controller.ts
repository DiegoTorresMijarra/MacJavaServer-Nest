...
export class RestaurantesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Obtiene todos los restaurantes paginados',
    type: Paginated<Restaurante>,
  })
  @ApiQuery({
  ...
  @ApiResponse({
    status: 200,
    description: 'Obtiene un restaurante por id',
    type: Restaurante,
  })
  ...
  @ApiBadRequestResponse({
    description: 'Error en los datos del nuevo restaurante',
  })
  @ApiBody({
    description: ' Datos del restaurante a crear',
    type: CreateRestauranteDto,
  })
  //@Roles('ADMIN')
  ...
  @ApiNotFoundResponse({
    description: 'No se encuentra el restaurante que quiere actualizar',
  })
  @ApiBadRequestResponse({
    description: 'Error en los datos del restaurante a actualizar',
  })
  @ApiParam({ name: 'id', description: 'Id del restaurante', type: Number })
  @ApiBody({
  ...
  @ApiResponse({
    status: 200,
    description: 'Obtiene un restaurante por nombre',
    type: Restaurante,
  })
  @ApiNotFoundResponse({ description: 'No se encuentra el restaurante' })
  @ApiParam({
    name: 'nombre',
    description: 'Nombre del restaurante que se quiere buscar',
    type: String,
  })
