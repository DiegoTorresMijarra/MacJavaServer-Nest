...
describe('RestaurantesMapper', () => {
    ...
    describe('createDtoToEntity', () => {
        it('deberia convertir un dto a una entidad', () => {
            ...
            expect(entidad.nombre).toEqual(dto.nombre);
            expect(entidad.calle).toEqual(dto.calle);
            expect(entidad.localidad).toEqual(dto.localidad);
    ...
    describe('updateDtoToEntity', () => {
        it('deberia actualizar una entidad con los datos de un dto', () => {
            ...
            expect(entidad2.nombre).toEqual(dto.nombre);
            expect(entidad2.calle).toEqual(dto.calle);
            expect(entidad2.localidad).toEqual(dto.localidad);
