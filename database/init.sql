...
CREATE TABLE "public"."trabajadores" (
                                    ...
                                    CONSTRAINT "trabajadores_pk" PRIMARY KEY ("uuid"),
...
INSERT INTO "trabajadores" ("uuid", "dni", "nombre", "apellido", "edad", "telefono", "posicion_id")
VALUES
    ('00000000-0000-0000-0001-000000000001', '53718369Y', 'admin', 'admin', 25, '629384747', 1),
    ('00000000-0000-0000-0001-000000000002', '20500036K', 'user', 'user', 30, '629384748', 2),
    (uuid_generate_v4(), '39372090T', 'Jim', 'Smith', 35, '629384749', 3),
    (uuid_generate_v4(), '42394835Q', 'Sarah', 'Johnson', 40, '629384750', 4),
    (uuid_generate_v4(), '90594482N', 'Mike', 'Brown', 45, '629384746', 4);
